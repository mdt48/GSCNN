...
labels = [
    ...
    Label(  'chair'                ,  0 ,      255 , 'dining room'            , 0       , True         , True         , (  0,  0,  0) ),
    Label(  'wall'                 ,  1 ,      255 , 'dining room'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'window'               ,  2 ,      255 , 'dining room'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'table'                ,  3 ,      255 , 'dining room'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'ceiling'              ,  4 ,      255 , 'dining room'            , 0       , False        , True         , (  0,  0,  0) ),
    Label(  'floor'                ,  5 ,      255 , 'dining room'            , 0       , False        , True         , (111, 74,  0) ),
    Label(  'painting'             ,  6 ,      255 , 'dining room'            , 0       , False        , True         , ( 81,  0, 81) ),
    Label(  'plate'                ,  7 ,        0 , 'dining room'            , 0       , False        , False        , (128, 64,128) ),
    Label(  'cabinet'              ,  8 ,        1 , 'dining room'            , 0       , False        , False        , (244, 35,232) ),
    Label(  'curtain'              ,  9 ,      255 , 'dining room'            , 0       , False        , True         , (250,170,160) ),
    Label(  'ceiling lamp'         , 10 ,      255 , 'dining room'            , 0       , False        , True         , (230,150,140) ),
    Label(  'vase'                 , 11 ,        2 , 'dining room'            , 0       , False        , False        , ( 70, 70, 70) ),
    Label(  'plant'                , 12 ,        3 , 'dining room'            , 0       , False        , False        , (102,102,156) ),
    Label(  'flowers'              , 13 ,        4 , 'dining room'            , 0       , False        , False        , (190,153,153) ),
    Label(  'cup'                  , 14 ,      255 , 'dining room'            , 0       , False        , True         , (180,165,180) ),
    Label(  'door'                 , 15 ,      255 , 'dining room'            , 0       , False        , True         , (150,100,100) ),
    Label(  'chandelier'           , 16 ,      255 , 'dining room'            , 0       , False        , True         , (150,120, 90) ),
    Label(  'picture'              , 17 ,        5 , 'dining room'            , 0       , False        , False        , (153,153,153) ),
]
